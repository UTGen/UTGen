# Replication Package: Enhancing Understandability of Generated Unit Tests with LLMs

Welcome to the replication package for the research project "Leveraging Large Language Models for Enhancing the Understandability of Generated Unit Tests". This guide will walk you through setting up and using the tools involved in our study, including a Large Language Model (LLM) server and the UTGen.
